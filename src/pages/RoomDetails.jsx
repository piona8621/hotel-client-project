  ...
  return (
    <>
      <div className="max-w-3xl mx-auto mt-10 p-6 bg-purple-600 bg-opacity-40 shadow-lg rounded-lg">
        ...
        <h2 className='text-3xl mt-2 mb-4 font-bold font-serif italic text-purple-200'>
          <span className="text-3xl font-bold font-serif text-yellow-500 italic">Room</span> Details
        </h2>
        ...
        <p className={`mt-2 text-lg font-medium ${isBooked ? 'text-red-500' : 'text-green-500'}`}>
          <strong>{isBooked ? '❌' : '✅'} Availability:</strong> {isBooked ? 'Booked' : 'Available'}
        </p>
        ...
        {showBookingModal && (
          <div className="fixed inset-0 bg-purple-900 bg-opacity-50 flex justify-center items-center z-50">
            <div className="bg-purple-600 bg-opacity-40 p-6 rounded-lg shadow-lg w-full max-w-md">
              <div className="flex justify-between items-center border-b pb-3">
                <h2 className="text-2xl ml-20 text-purple-300 font-serif italic font-bold">
                  <span className='text-yellow-400 text-2xl font-serif italic'>Booking</span> Summary
                </h2>
                <button
                  onClick={handleCloseBookingModal}
                  className="text-gray-500 hover:text-gray-700 text-xl font-bold"
              ...
              <div className="mt-4">
                ...
                <p className="text-purple-100 text-2xl">
                  <strong className='font-serif italic text-yellow-400'>Room:</strong> {room.name}
                </p>
                <p className="text-white text-lg">
                  <strong className='text-xl font-serif italic text-yellow-400'>Description:</strong> {room.description}
                </p>
                <p className="text-white text-lg">
                  <strong className='text-xl font-serif italic text-yellow-400'>Price:</strong> {room.price}
                </p>
                <label className="block mt-4 text-purple-200 italic font-serif text-xl font-bold">Booking Date:</label>
                <DatePicker
                  selected={startDate}
